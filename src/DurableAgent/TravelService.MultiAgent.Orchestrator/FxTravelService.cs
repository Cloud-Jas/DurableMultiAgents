...
namespace TravelService.MultiAgent.Orchestrator
{
   public class FxTravelService
   {
      ...
      public FxTravelService(ICosmosClientService cosmosClientService, INL2SQLService nL2SQLService, IHttpMiddlewareBuilder middlewareBuilder, IUserServiceClient userServiceClient)
      {
          ...
          FunctionContext executionContext)
      {
         ...
         var userDetails = await _userServiceClient.GetPassengerByIdAsync(userId);
