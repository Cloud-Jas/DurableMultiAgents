...
2. For services using a database, environment variables have been pre-configured under the `env` node in the following files to allow connection to the database. Modify the name of these variables as needed to match your application.
    - [app/TravelService.MultiAgent.Orchestrator.bicep](./infra/app/TravelService.MultiAgent.Orchestrator.bicep)
    - [app/TravelService.MultiAgent.SeedData.bicep](./infra/app/TravelService.MultiAgent.SeedData.bicep)
...
- [app/TravelService.MultiAgent.Orchestrator.bicep](./infra/app/TravelService.MultiAgent.Orchestrator.bicep) - Azure Container Apps resources to host the 'TravelService.MultiAgent.Orchestrator' service.
- [app/TravelService.MultiAgent.SeedData.bicep](./infra/app/TravelService.MultiAgent.SeedData.bicep) - Azure Container Apps resources to host the 'TravelService.MultiAgent.SeedData' service.
